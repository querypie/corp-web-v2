...
export const integrationItems: IntegrationItem[] = [
  ...
  { name: "AWS", icon: `${iconBasePath}/aws.svg`, enhanceIconContrast: true, categories: ["development-devops"] },
  ...
  { name: "Daum Search", icon: `${iconBasePath}/daum-search.svg`, categories: ["search-navigation"] },
  ...
  { name: "MySQL", icon: `${iconBasePath}/mysql.svg`, invertIcon: true, categories: ["database-connections"] },
