...
type AboutUsRouteProps = {
  params: Promise<{ locale: string }>;
};

export default async function AboutUsRoute({ params }: AboutUsRouteProps) {
  ...
  const copy = {
    en: {
      ...
      journeyItems: [
        ...
        {
          details: ["Funding from Kakao Investment", "Development started QueryPie SQL Client"],
          year: "2018",
        },
        {
          details: [
        ...
        {
          details: ["Fundraised $17.75M in Preferred Seed Round"],
          year: "2021",
        },
        {
          details: ["Secured $5.81M funding by Korea Credit Guarantee Fund"],
          year: "2023",
        },
        {
          details: [
    ...
    ko: {
      ...
      journeyItems: [
        ...
        {
          details: ["카카오인베스트먼트 투자 유치", "QueryPie SQL Client 개발 시작"],
          year: "2018",
        },
        {
          details: ["QueryPie SQL Client 출시", "TechCrunch SF 2019 참가", "LG Startup Competition 2019 수상"],
          year: "2019",
        },
        {
          details: ["Y-Combinator 투자 유치", "Data Protection Platform으로 피벗", "야놀자, 카카오페이, 두나무 등에 QueryPie 공급"],
          year: "2020",
        },
        {
          details: ["Preferred Seed Round로 1,775만 달러 투자 유치"],
          year: "2021",
        },
        {
          details: ["신용보증기금으로부터 581만 달러 확보"],
          year: "2023",
        },
        {
          details: ["QueryPie Japan 출범", "Salesforce Ventures, Z Venture Capital 등 전략적 투자 유치"],
          year: "2024",
        },
      ],
      journeyTitle: "Our Journey",
