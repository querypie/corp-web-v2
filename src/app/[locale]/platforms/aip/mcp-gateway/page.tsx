...
import ContentEN, { metadata as metadataEN } from "@/components/pages/platforms/aip/mcp-gateway/content.en";
import ContentKO, { metadata as metadataKO } from "@/components/pages/platforms/aip/mcp-gateway/content.ko";
import ContentJA, { metadata as metadataJA } from "@/components/pages/platforms/aip/mcp-gateway/content.ja";
...
export async function generateMetadata({ params }: Pick<PageProps, "params">): Promise<Metadata> {
  ...
  return withDynamicOgImage({
    ...
    alternates: {
      canonical: getPlatformHref(locale, "mcp-gateway"),
    },
