...
import ContentEN, { metadata as metadataEN } from "@/components/pages/platforms/aip/fde-services/content.en";
import ContentKO, { metadata as metadataKO } from "@/components/pages/platforms/aip/fde-services/content.ko";
import ContentJA, { metadata as metadataJA } from "@/components/pages/platforms/aip/fde-services/content.ja";
...
export async function generateMetadata({ params }: Pick<PageProps, "params">): Promise<Metadata> {
  ...
  return withDynamicOgImage({
    ...
    alternates: {
      canonical: getPlatformHref(locale, "fde-services"),
    },
