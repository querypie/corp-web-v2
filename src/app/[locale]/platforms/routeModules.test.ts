...
import Content1EN, { metadata as Metadata1EN } from "@/components/pages/platforms/aip/content.en";
import Content1KO, { metadata as Metadata1KO } from "@/components/pages/platforms/aip/content.ko";
import Content1JA, { metadata as Metadata1JA } from "@/components/pages/platforms/aip/content.ja";
import { generateMetadata as g2 } from "./aip/usage-based-llm/page";
import Page2 from "./aip/usage-based-llm/page";
import Content2EN, { metadata as Metadata2EN } from "@/components/pages/platforms/aip/usage-based-llm/content.en";
import Content2KO, { metadata as Metadata2KO } from "@/components/pages/platforms/aip/usage-based-llm/content.ko";
import Content2JA, { metadata as Metadata2JA } from "@/components/pages/platforms/aip/usage-based-llm/content.ja";
import { generateMetadata as g3 } from "./aip/mcp-gateway/page";
import Page3 from "./aip/mcp-gateway/page";
import Content3EN, { metadata as Metadata3EN } from "@/components/pages/platforms/aip/mcp-gateway/content.en";
import Content3KO, { metadata as Metadata3KO } from "@/components/pages/platforms/aip/mcp-gateway/content.ko";
import Content3JA, { metadata as Metadata3JA } from "@/components/pages/platforms/aip/mcp-gateway/content.ja";
import { generateMetadata as g4 } from "./aip/fde-services/page";
import Page4 from "./aip/fde-services/page";
import Content4EN, { metadata as Metadata4EN } from "@/components/pages/platforms/aip/fde-services/content.en";
import Content4KO, { metadata as Metadata4KO } from "@/components/pages/platforms/aip/fde-services/content.ko";
import Content4JA, { metadata as Metadata4JA } from "@/components/pages/platforms/aip/fde-services/content.ja";
...
import Content6EN, { metadata as Metadata6EN } from "@/components/pages/platforms/acp/content.en";
import Content6KO, { metadata as Metadata6KO } from "@/components/pages/platforms/acp/content.ko";
...
describe("platforms route modules", () => {
