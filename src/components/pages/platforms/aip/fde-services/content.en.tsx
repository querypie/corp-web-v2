...
const featureItems = [
  {
    ...
    imageSrc: "/assets/pages/platforms/aip/fde-services/find-problems.webp",
  ...
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/fde-services/make-plans.webp",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    reverse: true,
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/fde-services/build-custom-ai-agents.webp",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
  },
  {
    title: ["Make AI Work"],
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/fde-services/make-ai-work.webp",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    reverse: true,
  },
];
    ...
    <div className={`flex w-full flex-col ${pageSectionGapClassName} ${pageXPaddingClassName}`}>
      <div className="flex w-full flex-col gap-10 md:gap-[80px]">
        ...
        <Hero
          ...
          imageSrc="/assets/pages/platforms/aip/fde-services/fde.svg"
        />
      </div>
