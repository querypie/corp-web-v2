...
const featureItems = [
  {
    ...
    imageSrc: "/assets/pages/platforms/aip/usage-based-llm/aip_function_pay.gif",
  ...
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/usage-based-llm/aip_function_llmmodel.gif",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    reverse: true,
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/usage-based-llm/aip_function_sso.gif",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
  },
];
    ...
    <div className={`flex w-full flex-col ${pageSectionGapClassName} ${pageXPaddingClassName}`}>
      <div className="flex w-full flex-col gap-10 md:gap-[80px]">
        ...
        <Hero
          ...
          imageSrc="/assets/pages/platforms/aip/usage-based-llm/usage-based-llm.svg"
        />
      </div>
