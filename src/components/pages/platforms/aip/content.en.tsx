...
import ThreeCard from "@/components/pages/platforms/aip/ThreeCard";
  ...
  return [
    {
      ...
      imageSrc: "/assets/pages/platforms/aip/aip_function_prompt.gif",
    ...
    },
    {
      ...
      imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
      imageSrc: "/assets/pages/platforms/aip/aip_function_integration.gif",
      mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
      reverse: true,
    ...
    },
    {
      ...
      imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
      imageSrc: "/assets/pages/platforms/aip/aip_function_knowledge.gif",
      mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    ...
    },
    {
      ...
      imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
      imageSrc: "/assets/pages/platforms/aip/aip_function_createagent.gif",
      mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
      reverse: true,
    ...
    },
    {
      ...
      imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
      imageSrc: "/assets/pages/platforms/aip/aip_function_visualization.gif",
      mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    ...
    },
    {
      ...
      imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
      imageSrc: "/assets/pages/platforms/aip/aip_function_schedule.gif",
      mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
      reverse: true,
        ...
        <div>
          <section className="flex w-full justify-center">
            <YoutubePreviewPlayer
              ...
              thumbnailSrc="/assets/pages/platforms/aip/aip-cover.png"
              title="QueryPie AI Platform video"
              videoSrc="/assets/pages/platforms/aip/QueryPie%20AIP%20-%20Secure%20Enterprise%20Agentic%20AI%20Platform.mp4"
            />
          </section>
        </div>
      </div>
