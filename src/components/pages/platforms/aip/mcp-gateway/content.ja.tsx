...
import Hero from "@/components/pages/platforms/aip/Hero";
...
const featureItems = [
  {
    ...
    imageSrc: "/assets/pages/platforms/aip/mcp-gateway/aip_function_tunneling.gif",
  ...
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/mcp-gateway/aip_function_mcpproxy.gif",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    reverse: true,
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/mcp-gateway/aip_function_mcpmanagement.gif",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
  },
  {
    title: ["監査ログ"],
    ...
    imageAlt: "監査ログプレビュー",
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/mcp-gateway/aip_function_audit.gif",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
    reverse: true,
  },
  {
    ...
    imageClassName: "h-auto w-full md:h-[400px] md:w-auto",
    imageSrc: "/assets/pages/platforms/aip/mcp-gateway/aip_function_dlp.gif",
    mediaClassName: "aspect-auto h-auto w-full md:h-[400px] md:w-fit md:max-w-full lg:w-fit lg:max-w-none",
  },
];
    ...
    <div className={`flex w-full flex-col ${pageSectionGapClassName} ${pageXPaddingClassName}`}>
      <div className="flex w-full flex-col gap-10 md:gap-[80px]">
        ...
        <Hero
          ...
          imageSrc="/assets/pages/platforms/aip/mcp-gateway/mcp-gateway.png"
        />
      </div>
