...
const cardImages = {
  "usage-based-llm": "/assets/pages/platforms/aip/three-card/usage-based-llm.png",
  "mcp-gateway": "/assets/pages/platforms/aip/three-card/mcp-gateway.png",
  "fde-services": "/assets/pages/platforms/aip/three-card/fde-services.png",
} as const;
      ...
      <div className="flex w-full max-w-[1200px] flex-col items-center gap-10">
        ...
        <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {content.cards.map((card) => (
            <article
              className="flex min-w-0 flex-col overflow-hidden rounded-box bg-bg"
              key={card.title.join(" ")}
            >
              <header className="relative aspect-[747/376] w-full overflow-hidden">
                <Image
                  alt=""
                  aria-hidden="true"
                  className="object-cover"
                  fill
                  sizes="(min-width: 1024px) 386px, (min-width: 640px) 50vw, 100vw"
                ...
                />
                <h3 className="absolute inset-0 m-0 flex w-full flex-col justify-center px-6 type-h2 font-medium text-white md:px-7.5">
                  {card.title.map((line) => (
              ...
              <div className="flex flex-1 flex-col items-start gap-6 px-5 pb-7 pt-7 md:px-7.5 md:pb-8 md:pt-8">
                ...
                <TextButton
                  ...
                  href={getPlatformHref(locale, card.id)}
                >
                  {content.learnMore}
                </TextButton>
              </div>
