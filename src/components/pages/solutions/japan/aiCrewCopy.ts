...
export const aiCrewCopy = {
  en: {
    ...
    useCases: {
      ...
      items: [
        { id: "seo-analyst", imageSrc: "/demo/aip-features/aip-use-case-2.webp", tags: ["Marketing", "SEO"], title: "SEO analysis", body: "Support site analysis, prioritize improvements, and build dashboards that make the next action clear." },
        { id: "quotation-analyze-ai-agent", imageSrc: "/demo/aip-features/aip-use-case-1.webp", tags: ["Sales", "Quote analysis"], title: "Quote operations", body: "Analyze, compare, and prepare quotes while reducing time spent reviewing and transferring information." },
        { id: "dev-insight-ai-agent", imageSrc: "/demo/aip-features/aip-use-case-15.webp", tags: ["Engineering", "DevOps"], title: "Development insights", body: "Connect Git, PRs, tickets, CI/CD, and incidents to reveal status and risk through conversation." },
        { id: "data-analytics-agent", imageSrc: "/demo/aip-features/aip-use-case-6.webp", tags: ["Analytics", "Visualization"], title: "Data analysis", body: "Support data extraction, visualization, and insight development from natural-language questions." },
        { id: "work-collaboration-agent", imageSrc: "/demo/aip-features/aip-use-case-11.webp", tags: ["Collaboration", "Work automation"], title: "Work collaboration", body: "Connect Slack, Jira, and Confluence to automate routine coordination and keep information moving across teams." },
        { id: "security-audit-agent", imageSrc: "/demo/aip-features/aip-use-case-10.webp", tags: ["Security", "Audit"], title: "Security audit", body: "Investigate access patterns, detect anomalies, and generate compliance reports through natural-language requests." },
      ],
    },
    voices: {
  ...
  ko: {
    ...
    useCases: {
      ...
      action: "모든 활용 사례 보기",
      items: [
        { id: "seo-analyst", imageSrc: "/demo/aip-features/aip-use-case-2.webp", tags: ["마케팅", "SEO"], title: "SEO 분석", body: "사이트 분석, 개선 항목 정리, 대시보드 구성을 지원해 다음 실행 과제를 명확하게 합니다." },
        { id: "quotation-analyze-ai-agent", imageSrc: "/demo/aip-features/aip-use-case-1.webp", tags: ["견적·영업", "견적 분석"], title: "견적 업무", body: "견적서 분석, 비교, 작성을 지원해 확인과 정보 입력에 드는 시간을 줄입니다." },
        { id: "dev-insight-ai-agent", imageSrc: "/demo/aip-features/aip-use-case-15.webp", tags: ["개발", "DevOps"], title: "개발 인사이트", body: "Git, PR, 티켓, CI/CD, 인시던트를 연결해 상황과 위험을 대화형으로 보여줍니다." },
        { id: "data-analytics-agent", imageSrc: "/demo/aip-features/aip-use-case-6.webp", tags: ["분석·경영", "데이터 시각화"], title: "데이터 분석", body: "자연어 질문을 바탕으로 데이터 추출, 시각화, 인사이트 정리까지 지원합니다." },
        { id: "work-collaboration-agent", imageSrc: "/demo/aip-features/aip-use-case-11.webp", tags: ["협업", "업무 자동화"], title: "업무 협업", body: "Slack, Jira, Confluence를 연결해 반복적인 협업 업무와 부서 간 정보 공유를 자동화합니다." },
        { id: "security-audit-agent", imageSrc: "/demo/aip-features/aip-use-case-10.webp", tags: ["보안", "감사"], title: "보안 감사", body: "자연어 요청으로 접근 패턴을 조사하고 이상 징후를 탐지하며 컴플라이언스 보고서를 생성합니다." },
      ],
    },
    voices: {
