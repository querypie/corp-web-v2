...
type LegalContentBodyProps = {
  bodyHtml: string;
  tableTone?: "content" | "deep";
};

export default function LegalContentBody({
  bodyHtml,
  tableTone = "content",
}: LegalContentBodyProps) {
  ...
  return (
    <div
      className={[
        ...
        "[&_a]:text-brand [&_a]:decoration-1 [&_a]:underline-offset-4 [&_a:hover]:underline",
