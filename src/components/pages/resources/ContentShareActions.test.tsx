...
describe("ContentShareActions", () => {
  ...
  it("URL 복사 버튼을 누르면 현재 페이지 URL을 클립보드에 복사한다", async () => {
    window.history.replaceState(null, "", "/en/features/resources/security-guide");
    ...
    expect(writeText).toHaveBeenCalledWith("http://localhost:3000/en/features/resources/security-guide");
