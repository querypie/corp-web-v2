...
date: "2025-01-23"
author: "fabian"
ogImage: "public/white-paper/wp-thumb-11.png"
...
<Box center>
    <ArticleFileImage
        filepath="public/white-paper/wp11-1-diary-overview.png"
        alt="Diary Overview"
...
- 대용량 로그 데이터 저장 조회시 일반적으로 사용되는 경로 기반 Partitioning을 사용해 조회 및 외부 연동을 용이 하게 합니다
    ...
    **Athena 연동 및 조회 Example**
    ...
    <Box center>
        <ArticleFileImage
            filepath="public/white-paper/wp11-2-results-table.png"
            alt="result"
        />
    </Box>
    <br />
    ...
    <Box center>
        <ArticleFileImage
            filepath="public/white-paper/wp11-3-bloom-filter.png"
            alt="Bloom Filter"
    ...
    <Box center>
        <ArticleFileImage
            filepath="public/white-paper/wp11-4-querypie-oven.png"
            alt="QueryPie OVEN"
        />
    </Box>
    <br />
