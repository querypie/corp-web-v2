...
<Box center>
    <ArticleFileImage
        filepath="public/white-paper/11/1-diary-overview.png"
        alt="Diary Overview"
...
- To optimize retrieval and external integration, a path-based partitioning system—commonly used for large-scale log data storage and querying—has been implemented.
    ...
    **Athena Integration and Query Example**
    ...
    <Box center>
        <ArticleFileImage
            filepath="public/white-paper/11/2-results-table.png"
            alt="result"
        />
    </Box>
    <br />
    ...
    <Box center>
        <ArticleFileImage
            filepath="public/white-paper/11/3-bloom-filter.png"
            alt="Bloom Filter"
    ...
    <Box center>
        <ArticleFileImage
            filepath="public/white-paper/11/4-querypie-oven.png"
            alt="QueryPie OVEN"
        />
    </Box>
    <br />
