...
date: "2024-11-22"
author: "evan"
ogImage: "public/whitepapers/3/thumbnail.png"
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/1-execution-phases.png"
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/2-MySQL-ANTLR4.png"
        alt="MySQL (ANTLR4)"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/3-Oracle-ANTLR4.png"
        alt="Oracle (ANTLR4)"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/4-PostgreSQL-YACC.png"
        alt="PostgreSQL (YACC)"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/5-qsi-ast-Data-Reference.png"
        alt="Data Reference"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/6-qsi-ast-Derived-Table.png"
        alt="Derived Table"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/7-qsi-ast-Joined-Table.png"
        alt="Joined Table"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/8-qsi-ast-Compound-Table-Combination.png"
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/9-qsi-ast-Inline-Derived-Table.png"
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/10-qsi-ast-Table-Function-Call.png"
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/11-analysis-result.png"
        alt="Analysis Result"
    />
</Box>
<br />
...
<Box marginTopSize="xs" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/12-analysis-result-2.png"
        alt="Analysis Result"
    />
</Box>
<br />
...
<Box marginTopSize="sm" center>
    <ArticleFileImage
        filepath="public/whitepapers/3/13-analysis-result-3.png"
        alt="Analysis Result"
    />
</Box>
<br />
