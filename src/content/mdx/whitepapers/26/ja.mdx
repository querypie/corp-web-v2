...
date: "2026-02-13"
author: "edwin"
ogImage: "public/whitepapers/26/thumbnail.png"
hideOgImage: true
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/thumbnail.png"
...
> 本記事は前後編の**前編**です。前編では研究の背景・システムアーキテクチャ・実験設計を、[後編](/ja/whitepapers/27)では実験結果・パイプライン最適化・結論を取り扱います。
<br/>
<br/>
---
# 序論
...
> 第4章以降の実験結果・パイプライン最適化・結論は[後編](/ja/whitepapers/27)で取り扱います。
<br/>
<br/>
---
# 第1章　関連研究
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/fig1-pipeline-structure.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/fig2-nl-to-pseudocode-flow.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table1-nl-pseudocode-io-example.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table2-mfid-metadata-structure.webp"
        alt="表2：MFIDメタデータ構造"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/fig3-embedding-model-eval.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/fig4-mfid-mapping-flow.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table3-task-comparison.webp"
        alt="表3：評価対象タスク特性比較"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table4-claude-family.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table5-gemini-family.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table6-gpt-family.webp"
        alt="表6：GPTファミリーモデル"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table7-model-summary.webp"
        alt="表7：評価対象モデル要約"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table8-codegen-dataset.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table9-rag-dataset.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table10-llm-judge-criteria.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table11-token-pricing.webp"
...
<Box center>
    <ArticleFileImage
        filepath="public/whitepapers/26/table12-model-settings.webp"
        alt="表12：モデル設定"
        caption="表12：モデル設定"
    />
</Box>
...
<br/>
<br/>
> 📖 [後編](/ja/whitepapers/27)では、13モデルの実験結果（コード生成・Agentic RAG）、Thinkingモードの影響分析、安定性評価、コスト―品質トレードオフ、そして最適パイプライン構成戦略を詳しく取り扱います。
