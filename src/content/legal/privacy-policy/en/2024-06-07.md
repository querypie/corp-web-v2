...
- For the purpose of customer identification, authentication, and service handling upon provisioning QueryPie service
- For the purpose of service provision, demo requests, customer management, product inquiries, and customer support
- To provide Customer Support service for QueryPie customers
...
- When entering information directly after agreeing to the collection of personal information on the Request a demo page ([QueryPie](/jahttps://www.querypie.com/ko/demo-request)) and Contact Us page ([QueryPie](/jahttps://www.querypie.com/ko/demo-request))
...
- Vulnerability Bounty application page ([QueryPie Bug Bounty Program](https://forms.monday.com/forms/fedec489c20ba9620ee48034513f0593?r=use1))
- Compliance Bounty application page ([QueryPie Compliance Bounty Program](https://forms.monday.com/forms/60d48c7fb84349a83f526abb030045a3?r=use1))
...
- **Demo request and customer management, event survey, Bounty Program:** [monday.com](http://monday.com/) ([https://chequer.monday.com](https://chequer.monday.com/))
...
- **Demo request and customer management, survey event, Bounty Program:** [monday.com | A new way of working](http://monday.com/) as a CRM (Customer Relationship Management) platform
