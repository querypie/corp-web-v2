...
type StaticDescriptionKey =
  | "cookiePreference"
  | "eula"
  | "privacyPolicy"
  | "termsOfService";

const descriptions: Record<StaticDescriptionKey, Record<Locale, string>> = {
  cookiePreference: {
...
export function getStaticSeoDescription(key: StaticDescriptionKey, locale: Locale) {
